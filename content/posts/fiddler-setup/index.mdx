...
24. Click **Install** for the DO_NOT_TRUST_FiddlerRoot profile
    ![](./photos/photos/install_profile.png)

25. Enter your passcode if you have one
    ![](./photos/photos/passcode.png)
...
Hopefully this guide has helped you out. I wanted to make this guide as a way to guide others and remind if I need to re-install Fiddler.  
The guides online are good but they don't show all the screenshots
