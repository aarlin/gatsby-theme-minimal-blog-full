...
Download and install [LDPlayer9](https://www.ldplayer.net/)

![](./images/1.jpg)

OR use the direct link: https://ldcdn.ldmnq.com/download/ldad/LDPlayer9.exe?n=LDPlayer9_ens_1001_ld.exe

![](./images/2.png)

Open the emulator, and it should look like this when started, minus the apps I have already installed  
You should drag and drop your `.apk` file into anywhere on the emulator screen. It should appear on the home screen.
...
Finally, reopen you want to monitor HTTPS traffic for
...
Make sure `frida-tools` was installed by testing `frida-ps`
...
This is the most up-to-date version from https://github.com/frida/frida/releases
