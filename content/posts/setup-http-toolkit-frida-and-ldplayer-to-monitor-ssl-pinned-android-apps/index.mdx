---
title: Setup HTTP Toolkit, Frida, and LDPlayer to Monitor SSL Pinned Android Apps
date: 2023-02-19
...
For more context, this tutorial is following similar steps to this post originally from HttpToolkit's [blogspot](https://httptoolkit.com/blog/frida-certificate-pinning/), however under Windows
...
Double check that installed and is working properly
