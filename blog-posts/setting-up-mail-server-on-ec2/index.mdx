...
<Step number={1} title="Start with Route 53 on AWS by searching for a domain name."/>
...
<Step number={2} title="Enter your contact information"/>

![](/assets/images/blog-posts/setting-up-mail-server-on-ec2/2.png)

<Step number={3} title="Verify and accept if you want to renew domain automatically, accept terms & conditions, and complete order"/>
![](/assets/images/blog-posts/setting-up-mail-server-on-ec2/3.png)

<Step number={4} title="It'll take a few minutes for domain registration to take place. "/>
...
<Step number={5} title="In the meantime, go to [EC2](https://console.aws.amazon.com/ec2/v2/home?region=us-east-1#Instances:)"/>
...
<Step number={6} title="Under [Security Groups](https://console.aws.amazon.com/ec2/v2/home?region=us-east-1#SecurityGroups:),"/>
...
<Step number={7} title="Attach this security group to your EC2 instance by right clicking your instance, choosing Security and Change security group"/>
...
<Step number={8} title="Go to [Elastic IPs](https://console.aws.amazon.com/ec2/v2/home?region=us-east-1#Addresses:) and allocate an elastic IP address"/>
...
<Step number={9} title="Under [hosted zones](https://console.aws.amazon.com/route53/v2/hostedzones#), "/>
...
<Step number={10} title="The rest is super simple. SSH into the EC2 instance and follow this [guide](https://mailcow.github.io/mailcow-dockerized-docs/i_u_m_install/)"/>

<Step number={11} title="If you set everything up, you should be able to access your mailcow server using: `https://${MAILCOW_HOSTNAME}` with the default credentials admin + password moohoo."/>